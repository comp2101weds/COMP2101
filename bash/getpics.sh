...
#download the tar file to the Picture directory which is made
...
#unpacking the downloaded tar in Pictures directory and then removing the local copy of tar file
test -f ~/Pictures/pics.tgz && tar zxf ~/Pictures/pics.tgz -C ~/Pictures/pics.tgz && rm ~/Pictures/pics.tgz
